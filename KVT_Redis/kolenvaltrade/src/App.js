      ...
      return(
        <button class="btn btn-warning changeUser" onClick = {() => {   
          fetch('/getUser', {
            ...
            .then(json => {
              this.setState({flag: true, login: json.login, password: '', name: json.name, phone: json.phone, loginValid: true,
      ...
      for(let ad of this.props.ads){
        ads.push(
          <div class='ad' id={ad._id}>
            ...
            <div>
              <h4>{ad.manufactor} {ad.model}</h4> <h5>{ad.price}$</h5>
              <h4>{ad.region} область, город {ad.city}</h4>
              <p>
              ...
              <button class='btn btn-secondary delete' onClick={() => {
                this.props.onSend({ad: {_id: ad._id, user: ad.user}})
              }}>delete</button>
            </div>            
          </div>
        )
  ...
  render(){
    ...
    return(
      <div class='advertisement'>
        ...
        />
        <h4>{this.state.ad.manufactor} {this.state.ad.model}</h4> <h5>{this.state.ad.price}$</h5>
        <h4>{this.state.ad.region} область, город {this.state.ad.city}</h4>
        <h4>seller name {this.state.ad.user[0]} phone {this.state.ad.user[1]}</h4>
        <p>
